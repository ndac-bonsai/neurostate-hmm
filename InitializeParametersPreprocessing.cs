...
namespace neurostate_hmm
{
    ...
    public class InitializeParametersPreprocessing
    {
        ...
        */
        public InitializeParametersPreprocessing()
        {}
        ...
        */
        public IObservable<InitializeParametersPreprocessing> Process()
        {
            ...
            return Observable.Defer(() => Observable.Return(
                new InitializeParametersPreprocessing()
                {
