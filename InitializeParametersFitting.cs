...
{
    [Combinator]
    [Description("Contains all parameters necessary for Preprocessing LFP data and HSMM fitting")]
    [WorkflowElementCategory(ElementCategory.Source)]
    public class InitializeParametersFitting
    {
        ...
        */
        ...
        /*
        * No default values for the node parameters
        */
        public InitializeParametersFitting()
        {}
        ...
        */
        public IObservable<InitializeParametersFitting> Process()
        {
            ...
            return Observable.Defer(() => Observable.Return(
                new InitializeParametersFitting()
                {
