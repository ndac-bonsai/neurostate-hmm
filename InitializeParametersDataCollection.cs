...
{
    [Combinator]
    [Description("Contains all parameters necessary for Preprocessing LFP data and saving training data")]
    [WorkflowElementCategory(ElementCategory.Source)]
    public class InitializeParametersDataCollection
    {
        ...
        */
        ...
        /*
        * No defaults for node parameters
        */
        public InitializeParametersDataCollection()
        {}
        ...
        */
        public IObservable<InitializeParametersDataCollection> Process()
        {
            ...
            return Observable.Defer(() => Observable.Return(
                new InitializeParametersDataCollection()
                {
